...
\begin{table}[htpb]
    ...
    \begin{tabular}{lll}
        ...
        Frequency / Hz & S-Parameters / dB & Filter Type \& Characteristic \\
        \midrule
...
\begin{table}[htpb]
    ...
    \begin{tabular}{lll}
        \toprule
        \textbf{Adjusted} & \textbf{Measured} & \textbf{Calculated} \\
        Frequency / Hz & S-Parameters / dB & Linear Magnitude $|S_{\text{linear}}|$ \\
        \midrule
        901.327 MHz & \textbf{Bigger Circulator (Forward Transmission)} & \\
                    & $S_{21}$: -0.1956 dB & $|S_{21}|$: 0.9777 \\
                    & $S_{32}$: -0.1992 dB & $|S_{32}|$: 0.9773 \\
                    & $S_{13}$: -0.1919 dB & $|S_{13}|$ : 0.9781 \\
        \midrule
        901.327 MHz & \textbf{Bigger Circulator (Reflection \& Isolation)} & \\
        ...
        \midrule
        2.436 GHz   & \textbf{Small Circulator (Forward Transmission)} & \\
                    & $S_{21}$: -0.1491 dB & $|S_{21}|$: 0.9830 \\
                    & $S_{32}$: -0.1557 dB & $|S_{32}|$: 0.9822 \\
                    & $S_{13}$: -0.1704 dB & $|S_{13}|$: 0.9806 \\
        \midrule
        2.436 GHz   & \textbf{Small Circulator (Reflection \& Isolation)} & \\
...
\begin{table}[htpb]
    ...
    \begin{tabular}{lll}
        \toprule
        \textbf{Adjusted} & \textbf{Measured} & \textbf{Calculated} \\
        Frequency / Hz & Reflection Coefficient $S_{11}$ / dB & Impedance $Z_L$ / $\Omega$ and VSWR \\
        \midrule
        3.049430 GHz & \textbf{Antenna 1 (Corrected)} & \\
                     & $S_{11}$: -9.6100 dB & $Z_L$: 38.34 $\Omega$ - j28.07 $\Omega$ \\
                     & & VSWR: 1.99 \\
        \midrule
        2.512917 GHz & \textbf{Antenna 2 (with Ground Plane)} & \\
...
\begin{table}[htpb]
    ...
    \begin{tabular}{lll}
        ...
        \midrule
        Frequency / Hz & Matched $S_{11}$ / dB & Required Capacitance $C$ / F \\
        \midrule
...
\begin{table}[htpb]
    ...
    \begin{tabular}{lll}
        \toprule
        \textbf{Adjusted} & \textbf{Measured} & \textbf{Calculated} \\
        Frequency / Hz & $S_{11}$ Magnitude / dB & Calculated VSWR \\
        \midrule
        2.400000 GHz & \textbf{Unmatched Antenna} & \\
                     & $S_{11}$: -5.2699 dB & VSWR before: 3.40 \\
        \midrule
        2.400000 GHz & \textbf{Matched with Slide-Screw Tuner} & \\
