...
\vspace{3mm}
\\The following table~\ref{tab:refl_phase_n_load} shows calculated phase of the reflection coefficients for all 6 loads as well as their corresponding load impedances:
